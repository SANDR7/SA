...
// Plasmic Project: 2nuExkfYXAWQqM6SGWqR3e
// Component: TegXjcoAaKP
...
import projectcss from "./plasmic_sa_website.module.css"; // plasmic-import: 2nuExkfYXAWQqM6SGWqR3e/projectcss
import sty from "./PlasmicButton.module.css"; // plasmic-import: TegXjcoAaKP/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: SsEUQZtfchV/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: 1POq6cp1R2T/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__ntpYi)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__edK30)}
                role={"img"}
              />
            ),
